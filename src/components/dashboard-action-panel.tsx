...
export function DashboardActionPanel({
  ...
  contentClassName,
  badgeClassName = 'inline-flex items-center rounded-full border border-surface-200 bg-surface-100 px-3 py-1 text-[11px] font-semibold tracking-[0.22em] text-ink-300',
