...
import { buildLanguageSnippets } from './api-docs-language-snippets'
...
import type { ApiLanguageSnippet } from './api-docs-language-snippets'
...
export function buildApiDocsPageModel(t?: ApiDocsTranslate): ApiDocsPageModel {
  ...
  const languageSnippets: ApiLanguageSnippet[] = buildLanguageSnippets(t)
